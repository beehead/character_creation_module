"""Модуль создания героя."""
# Новый импорт.
# Из модуля start_game_banner, который расположен в папке grahic_arts,
...
def start_training(character):
    ...
    print(character.BREIF_DESC_CHAR_CLASS)
    ...
    while True:
        ...
        if cmd in commands:
            ...
            print('Только attack, defence, special или skip')
